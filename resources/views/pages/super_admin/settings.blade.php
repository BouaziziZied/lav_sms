...
@section('page_title', 'إدارة إعدادات النظام')
@section('content')
        ...
        <form enctype="multipart/form-data" method="post" action="{{ route('settings.update') }}">
            ...
            <div class="row">
                <div class="col-md-6 border-right-2 border-right-blue-400">
                    ...
                    <div class="form-group row">
                        <label for="current_session" class="col-lg-3 col-form-label font-weight-semibold">السنة الدراسية <span class="text-danger">*</span></label>
                        <div class="col-lg-9">
                            <select data-placeholder="إختر..." required name="current_session" id="current_session" class="select-search form-control">
                                <option value=""></option>
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label font-weight-semibold">إختصار المدرسة</label>
                        <div class="col-lg-9">
                            <input name="system_title" value="{{ $s['system_title'] }}" type="text" class="form-control" placeholder="إختصار المدرسة">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label font-weight-semibold">الهاتف</label>
                        <div class="col-lg-9">
                            <input name="phone" value="{{ $s['phone'] }}" type="text" class="form-control" placeholder="الهاتف">
                        </div>
                    </div>
                    <!-- <div class="form-group row">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label font-weight-semibold">البريد الإلكتروني للمدرسة</label>
                        <div class="col-lg-8">
                            <input name="system_email" value="{{ $s['system_email'] }}" type="email" class="form-control" placeholder="البريد الإلكتروني للمدرسة">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label font-weight-semibold">عنوان المدرسة <span class="text-danger">*</span></label>
                        <div class="col-lg-8">
                            <input required name="address" value="{{ $s['address'] }}" type="text" class="form-control" placeholder="عنوان المدرسة">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label font-weight-semibold">ينتهي هذا الفصل</label>
                        <div class="col-lg-5">
                            <input name="term_ends" value="{{ $s['term_ends'] }}" type="text" class="form-control date-pick" placeholder="تاريخ انتهاء الفصل">
                        </div>
                        <div class="col-lg-3 mt-2">
                            <span class="font-weight-bold font-italic">ي/ش/س </span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label font-weight-semibold">يبدأ الفصل التالي</label>
                        <div class="col-lg-5">
                            <input name="term_begins" value="{{ $s['term_begins'] }}" type="text" class="form-control date-pick" placeholder="تاريخ انتهاء الفصل">
                        </div>
                        <div class="col-lg-3 mt-2">
                            <span class="font-weight-bold font-italic">ي/ش/س </span>
                        </div>
