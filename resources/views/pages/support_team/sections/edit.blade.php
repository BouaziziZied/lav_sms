...
@section('page_title', 'تعديل فصل '.$s->my_class->name)
@section('content')

<div class="card">
    <div class="card-header header-elements-inline">
        <h6 class="card-title">تعديل فصل {{ $s->my_class->name }}</h6>
        {!! Qs::getPanelOptions() !!}
    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <form class="ajax-update" method="post" action="{{ route('sections.update', $s->id) }}">
                    ...
                    <div class="form-group row">
                        <label for="my_class_id" class="col-lg-3 col-form-label font-weight-semibold">الفصل </label>
                        <div class="col-lg-9">
