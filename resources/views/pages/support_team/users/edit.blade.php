        ...
        <form method="post" enctype="multipart/form-data" class="wizard-form steps-validation ajax-update" action="{{ route('users.update', Qs::hash($user->id)) }}" data-fouc>
            ...
            <fieldset>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input value="{{ $user->email }}" type="email" name="email" class="form-control" placeholder="البريد الإلكتروني">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input autocomplete="off" name="emp_date" value="{{ $user->staff->first()->emp_date ?? '' }}" type="text" class="form-control date-pick" placeholder="إختر التاريخ...">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select data-placeholder="إختر..." required name="nal_id" id="nal_id" class="select-search form-control">
                                <option value=""></option>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="d-block">حمل الصورة:</label>
