    ...
    <div class="page-header-content header-elements-md-inline">
        ...
        <div class="header-elements d-none">
            <div class="d-flex justify-content-center">
                ...
                <a href="{{ Qs::userIsSuperAdmin() ? route('settings') : '' }}" class="btn btn-link btn-float text-default"><i class="icon-arrow-down7 text-primary"></i> <span class="font-weight-semibold">السنة الدراسية: {{ Qs::getSetting('current_session') }}</span></a>
            </div>
        </div>
    </div>
