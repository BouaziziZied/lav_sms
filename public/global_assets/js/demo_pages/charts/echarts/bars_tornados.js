...
var EchartsBarsTornados = (function () {
    ...
    var _barsTornadosExamples = function () {
        ...
        var bars_clustered_element = document.getElementById(
            "bars_stacked_clustered"
        );
        var bars_float_element = document.getElementById("bars_float");
        var bars_mix_element = document.getElementById("bars_mix");
        var bars_tornado_negative_element = document.getElementById(
            "bars_tornado_negative"
        );
        var bars_tornado_staggered_element = document.getElementById(
            "bars_tornado_staggered"
        );
            ...
            bars_clustered.setOption({
                ...
                legend: {
                    data: [
                        "Version 1.7 - 2k data",
                        "Version 1.7 - 2w data",
                        "Version 1.7 - 20w data",
                        "",
                        "Version 2.0 - 2k data",
                        "Version 2.0 - 2w data",
                        "Version 2.0 - 20w data",
                    ],
                    itemHeight: 2,
                    itemGap: 8,
                    textStyle: {
        ...
        if (bars_float_element) {
            ...
            bars_float.setOption({
                ...
                tooltip: {
                    ...
                    formatter:
                        '<div class="mb-1">{b}</div>{a0}: {c0}%<br/>{a2}: {c2}%<br/>{a4}: {c4}%<br/>{a6}: {c6}%',
                },
                ...
                series: [
                    {
                        ...
                        data: [
                            1900, 1029, 1602, 2004, 1100, 1800, 2800, 1407,
                            2200, 900,
                        ],
                    },
                    {
                        ...
                        silent: true,
                        data: [
                            100, 1000, 800, 1070, 900, 300, 1200, 900, 1200,
                            200,
                        ],
                        itemStyle: {
                            normal: {
        ...
        if (bars_tornado_negative_element) {
            // Initialize chart
            var bars_tornado_negative = echarts.init(
                bars_tornado_negative_element
            );
        ...
        if (bars_tornado_staggered_element) {
            // Initialize chart
            var bars_tornado_staggered = echarts.init(
                bars_tornado_staggered_element
            );
