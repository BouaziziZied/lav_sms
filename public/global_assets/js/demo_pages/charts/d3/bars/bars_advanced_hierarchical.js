...
var D3BarHierarchy = (function () {
    ...
    var _barHierarchy = function () {
        ...
        if (element) {
            ...
            // Colors
            var color = d3.scale.ordinal().range(["#26a69a", "#ccc"]);
            ...
            d3.json(
                "../../../../global_assets/demo_data/d3/bars/bars_hierarchical.json",
                function (error, root) {
            ...
            svg.append("g").attr(
                "class",
                "d3-axis d3-axis-horizontal d3-axis-strong"
            );
