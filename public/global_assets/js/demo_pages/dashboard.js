...
var Dashboard = (function () {
    ...
    var _componentDaterange = function () {
        ...
        $(".daterange-ranges span").html(
            moment().subtract(29, "days").format("MMMM D") +
                " - " +
    ...
    var _TrafficSourcesStreamChart = function (element, height) {
        ...
        if ($(element).length > 0) {
            ...
            d3.csv(
                "../../../../global_assets/demo_data/dashboard/traffic_sources.csv",
                function (error, data) {
                    // Pull out values
                    ...
                    // Hide first tick
                    d3.select(
                        svg.selectAll(".d3-axis-left .tick text")[0][0]
                    ...
                    // Hide first tick
                    d3.select(
                        svg.selectAll(".d3-axis-right .tick text")[0][0]
                    ).style("visibility", "hidden");
                    ...
                    var xaxisg = svg
                        ...
                        .attr(
                            "class",
                            "d3-axis d3-axis-horizontal d3-axis-solid"
                        )
                                ...
                                tooltip
                                    .html(
                                        '<ul class="list-unstyled mb-1">' +
                                            "<li>" +
                                            '<div class="font-size-base my-1"><i class="icon-circle-left2 mr-2"></i>' +
                                            d.key +
                                            "</div>" +
                                            "</li>" +
                                            "<li>" +
                                            "Visits: &nbsp;" +
                                            "<span class='font-weight-semibold float-right'>" +
                                            pro +
                                            "</span>" +
                                            "</li>" +
                                            "<li>" +
                    ...
                    d3Container.on("mousemove", function (d, i) {
                        ...
                        tooltip.style(
                            "top",
                            mousey - $(".d3-tip").outerHeight() / 2 - 2 + "px"
            ...
            function resizeStream() {
                ...
                // Grid lines width
                svg.selectAll(".d3-grid-dashed").call(
                    gridAxis.tickSize(-width, 0, 0)
                );

                // Right vertical axis
                svg.selectAll(".d3-axis-right").attr(
                    "transform",
                    "translate(" + width + ", 0)"
                );
    ...
    var _AppSalesLinesChart = function (element, height) {
        ...
        if ($(element).length > 0) {
            ...
            var menu = $("#select_date").multiselect({
                buttonClass:
                    "text-default font-weight-semibold bg-transparent border-0 cursor-pointer outline-0 py-0 pl-0",
                enableHTML: true,
            ...
            d3.csv(
                "../../../../global_assets/demo_data/dashboard/app_sales.csv",
                function (error, data) {
                    formatted = data;
                    redraw();
                }
            ...
            function redraw() {
                ...
                svg.append("g").attr(
                    "class",
                    "d3-axis d3-axis-vertical d3-axis-transparent"
                );
                ...
                lines.each(function (d) {
                    d3.select(
                        d3.select(this).selectAll("circle")[0][
                            d3.select(this).selectAll("circle").size() - 1
                        ]
                    )
                        .on("mouseover", function (d) {
                ...
                function appSalesResize() {
                    ...
                    // Vertical axis
                    svg.select(".d3-axis-vertical").call(
                        yAxis.tickSize(0 - width)
                    );
                    ...
                    // Circles
                    svg.selectAll(".d3-line-circle").attr(
                        "cx",
                        function (d, i) {
                            return x(d.date);
                        }
    ...
    var _MonthlySalesAreaChart = function (element, height, color) {
        ...
        if ($(element).length > 0) {
            ...
            d3.json(
                "../../../../global_assets/demo_data/dashboard/monthly_sales.json",
                function (error, data) {
                    ...
                    function monthlySalesAreaResize() {
                        ...
                        // Horizontal axis subticks
                        svg.selectAll(".d3-axis-subticks")
                            .attr("x1", x)
                            .attr("x2", x);
                        ...
                        // Crosshair
                        svg.selectAll(".d3-crosshair-overlay").attr(
                            "width",
                            width
                        );
                    }
    ...
    var _AppSalesHeatmap = function (element) {
        ...
        if ($(element).length > 0) {
            // Load data
            d3.csv(
                "../../../../global_assets/demo_data/dashboard/app_sales_heatmap.csv",
                function (error, data) {
                    // Bind data
                    // ------------------------------
                    ...
                    data.forEach(function (d, i) {
                        (d.date = format.parse(d.date)), (d.value = +d.value);
                    });
                    ...
                    (margin = { top: 20, right: 0, bottom: 30, left: 0 }),
                        ...
                        (gridSize =
                            width /
                            new Date(data[data.length - 1].date).getHours()), // dynamically set grid size
                        (rowGap = 40), // vertical gap between rows
                        (height =
                            (rowGap + gridSize) *
                                d3.max(nest, function (d, i) {
                                    return i + 1;
                                }) -
                            margin.top),
                    ...
                    // Add map squares
                    var heatMap = hourGroup
                        .selectAll(".heatmap-hour")
                        .data(function (d) {
                            return d.values;
                        })
                        .enter()
                    ...
                    function resizeHeatmap() {
                        ...
                        // Legend group
                        svg.selectAll(".legend-group").attr(
                            "transform",
                            "translate(" +
                                (width / 2 - (buckets * gridSize) / 2) +
                                "," +
                        ...
                        // Sales count text
                        svg.selectAll(".sales-count").attr("x", width);
                        ...
                        svg.selectAll(".max-legend-value").attr(
                            "x",
                            buckets * gridSize + 10
                        );
                    }
            ...
            var tooltip = d3
                ...
                .html(function (d) {
                    return (
                        '<ul class="list-unstyled mb-1">' +
                        "<li>" +
                        '<div class="font-size-base my-1"><i class="icon-check2 mr-2"></i>' +
                        formatDate(d.date) +
                        "</div>" +
                        "</li>" +
                        "<li>" +
            ...
            var tip = d3
                ...
                .html(function (d) {
                    return (
                        '<ul class="list-unstyled mb-1">' +
                        "<li>" +
                        '<div class="font-size-base mb-1 mt-1">' +
                        d.data.icon +
                        d.data.browser +
                        "</div>" +
                        "</li>" +
    ...
    var _RoundedProgressChart = function (
        element,
        radius,
        border,
        color,
    ...
    var _BulletChart = function (element, height) {
        ...
        if ($(element).length > 0) {
                    ...
                    function bullet(g) {
                        g.each(function (d, i) {
                            ...
                            marker
                                ...
                                .attr("class", function (d, i) {
                                    return (
                                        "bullet-marker bullet-marker-" + (i + 1)
                                    );
                                })
                                .attr("x1", x0)
                                .attr("x2", x0)
                            ...
                            function resizeBulletsCore() {
                                ...
                                // Markers
                                g.selectAll(".bullet-marker")
                                    .attr("x1", x1)
                                    .attr("x2", x1);

                                // Ticks
                                g.selectAll(".bullet-tick").attr(
                                    "transform",
                                    bulletTranslate(x1)
                                );
                            }
            ...
            d3.json(
                "../../../../global_assets/demo_data/dashboard/bullets.json",
                function (error, data) {
                    // Show what's wrong if error
                    if (error) return console.error(error);
                    ...
                    // Title group
                    var title = svg.append("g").style("text-anchor", "start");
    ...
    return {
        ...
        initCharts: function () {
            ...
            _RoundedProgressChart(
                "#hours-available-progress",
                38,
                2,
                "#F06292",
                0.68,
                "icon-watch text-pink-400",
                "Hours available",
                "64% average"
            );
            _RoundedProgressChart(
